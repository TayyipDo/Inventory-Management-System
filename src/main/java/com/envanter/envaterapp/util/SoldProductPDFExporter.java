...
public class SoldProductPDFExporter {

    private List<SoldProduct> sales;

    public SoldProductPDFExporter(List<SoldProduct> sales) {
        this.sales = sales;
    }
    ...
    public void export(HttpServletResponse response) throws DocumentException, IOException {
        ...
        Paragraph title = new Paragraph("Satılmış Ürünler Listesi", font);
    ...
    private void writeTableData(PdfPTable table) {
        for (SoldProduct p : sales) {
            ...
            table.addCell(p.getCustomerName() + " (" + p.getCustomerPhone() + ")");
